...
export default function Settings({ creds, setCreds, settings, setSettings, riskConfig, setRiskConfig, onLogout }) {
  ...
  const saveCredentials = () => {
    if (!cid || !tok || !gkey) { alert('Please fill all fields'); return }
    const newCreds = { cid, tok, gkey }
    setCreds(newCreds)
          ...
          <div className="card">
            ...
            <div className="fr">
              ...
              <div style={{ fontSize: 11, color: 'var(--text3)', marginTop: 4 }}>
                Get free key at aistudio.google.com/app/apikey — 1,500 requests/day, no credit card
              </div>
            </div>
        ...
        <div>
          <div className="card">
            ...
            <div style={{ fontSize: 12, color: 'var(--text2)', lineHeight: 1.9 }}>
              ...
              API calls go directly from your browser to <b>Dhan</b> and <b>Google Gemini</b>.<br /><br />
